...
void GICV3_route_spi_to_cpu(const driver_handle *h, irq_id id, ARM_cpu_affinity affinity)
{
	GICV3_validate_spi_id_(h, id);
...
void GICV3_init_irq(const driver_handle *h, irq_id id, uint8 priority, gicv3_irq_trigger trigger,
...
void GICV3_ack_intid_el1(irq_id id)
{
