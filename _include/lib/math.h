...
#define log2_floor(x)                    \
	_Generic((x), uint32:            \
		 log2_floor_u32, uint64: \
		 log2_floor_u64, size_t: log2_floor_u64)(x)
#define log2_ceil(x)                    \
	_Generic((x), uint32:           \
		 log2_ceil_u32, uint64: \
		 log2_ceil_u64, size_t: log2_ceil_u64)(x)
...
#define next_pow2(x)    _Generic((x), uint32:           \
				 next_pow2_u32, uint64: \
				 next_pow2_u64)(x)
